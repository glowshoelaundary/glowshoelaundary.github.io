...
}
{
    ...
    function(a, b, c) {
        ...
        d.prototype.thumbnail = function(b, c) {
            ...
            h.length ? (l(h.attr(i)),
            h.remove(),
            !1) : void ("youtube" === c.type ? (f = "https://web.archive.org/web/20220215090058/http://img.youtube.com/vi/" + c.id + "/hqdefault.jpg",
            l(f)) : "vimeo" === c.type && a.ajax({
                type: "GET",
                url: "https://web.archive.org/web/20220215090058/http://vimeo.com/api/v2/video/" + c.id + ".json",
                jsonp: "callback",
                dataType: "jsonp",
                success: function(a) {
        ...
        d.prototype.play = function(b) {
            ...
            "youtube" === g.type ? c = '<iframe width="' + h + '" height="' + i + '" src="https://web.archive.org/web/20220215090058/http://www.youtube.com/embed/' + g.id + "?autoplay=1&v=" + g.id + '" frameborder="0" allowfullscreen></iframe>' : "vimeo" === g.type && (c = '<iframe src="https://web.archive.org/web/20220215090058/http://player.vimeo.com/video/' + g.id + '?autoplay=1" width="' + h + '" height="' + i + '" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>'),
...
/*
     FILE ARCHIVED ON 09:00:58 Feb 15, 2022 AND RETRIEVED FROM THE
...
/*
playback timings (ms):
  captures_list: 155.524
  exclusion.robots: 0.065
  exclusion.robots.policy: 0.056
  cdx.remote: 0.058
  esindex: 0.008
  LoadShardBlock: 96.944 (3)
  PetaboxLoader3.datanode: 88.644 (4)
  load_resource: 65.435
  PetaboxLoader3.resolve: 28.475
*/
